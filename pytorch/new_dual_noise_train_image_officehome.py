...
if __name__ == "__main__":
    ...
    parser.add_argument('--warm_up_epoch', type=int, default=2000, help="# art 650  clipart 1050  product 800 # rw 700  ")
    parser.add_argument('--gpu_id', type=str, nargs='?', default='3', help="device id to run")
    parser.add_argument('--net', type=str, default='ResNet50', choices=["ResNet18", "ResNet34", "ResNet50", "ResNet101", "ResNet152", "VGG11", "VGG13", "VGG16", "VGG19", "VGG11BN", "VGG13BN", "VGG16BN", "VGG19BN", "AlexNet"])
    parser.add_argument('--dset', type=str, default='office-home', choices=['office', 'image-clef', 'visda', 'office-home','DomainNet'], help="The dataset or source dataset used")
    parser.add_argument('--s_dset_path', type=str, default='../data/office-home/Art_40_.txt', help="The source dataset path list")
    parser.add_argument('--w_dset_path', type=str, default='../data/office-home/Art.txt', help="The source dataset path list")
    parser.add_argument('--t_dset_path', type=str, default='../data/office-home/Product.txt', help="The target dataset path list")
    parser.add_argument('--t_test_dset_path', type=str, default='../data/office-home/Product_shared.txt', help="The target dataset path list")
    ...
    task_name = args.output_dir + '/' + osp.basename(args.s_dset_path).upper() + '2' + osp.basename(args.t_dset_path).upper()
    ...
    config["data"] = {"source":{"list_path":args.s_dset_path, "batch_size":32}, \
                      ...
                      "test":{"list_path":args.t_test_dset_path, "batch_size":4},
